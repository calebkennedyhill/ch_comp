...
\[
    \skein{/skein_figs/trigon_singly}{0.1} 
    = t_1 \skein{/skein_figs/trivalent}{0.15} + t_2 \skein{/skein_figs/rightUp}{0.1}
\]
...
Suppose we have an equation in the two subcategory generators: trivalent and projection (and cups, caps, and sticks).
...
Usually, we take some middle ground.
Note that the only non-real generator of $K$ is $q$, whose part is played by $\eta$.
Thus we individually inspect the coefficients of $\eta$ and prove they are equal when specialized.
This is sufficient to prove a symbolic equation holds.